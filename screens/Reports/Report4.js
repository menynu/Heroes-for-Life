...
export default class Report4 extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            tableData : [],
            tableData2:[],
            tableHead: ['שם משלחת', 'סכ"ה נרשמים מפתיחת ההרשמה', 'גברים שנרשמו מפתיחת ההרשמה', 'גברים שנרשמו מפתיחת ההרשמה באחוזים', 'נשים שנרשמו מפתיחת ההרשמה', 'נשים שנרשמו מפתיחת ההרשמה באחוזים', 'נשים שנרשמו מפתיחת ההרשמה באחוזים'],
